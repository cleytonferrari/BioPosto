...
public class Util
{
    ...
    public int Identify(ref int score)
    {
        ...
        while (rs.Read())
        {
            ...
            tptRef = _DB.getTemplate(rs, 24);//Error se for NULL
            if (tptRef._size != -1)//Retorna -1 caso o campo Seja NULL no BD
            {
